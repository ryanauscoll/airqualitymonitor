...
instructions and that Firmata wouldn’t work to interface with this sensor. So, back to the drawing board.
...
I hope that UMD is doing a better job with ventilation than my current setup. :)
...
cool!). I also wanted to plot real-time CO2 values in DC from a different
...
project should be in every classroom/lecture hall at UMD, even if ventilation
